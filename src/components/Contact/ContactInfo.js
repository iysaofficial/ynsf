   ...
   const contactInfoData = [
      {
         ...
         title: 'Jl. Kemang NO. 63, Depok,',
         subtitle: 'Jawa Barat Indonesia'
      },
      {
         id: 2,
         icon_img: 'assets/img/icon/contact/mail.png',
         title: 'ynsf.iysa@gmail.com',
         subtitle: 'ynsf@youngscientist.or.id'
      },
      {
         id: 3,
         icon_img: 'assets/img/icon/contact/phone.png',
         title: '0817 - 7091 - 4129',
         subtitle: '+62 817-7091-4129'
      },
   ]
               ...
               <div className="row">
                  <div className="col-xxl-12">
                     <div className="page__title-wrapper text-center mb-55">
                        <h2 className="page__title-2">Kontak</h2>
                     </div>
                  </div>
               </div>
               <div className="row">
